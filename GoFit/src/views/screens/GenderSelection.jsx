...
const GenderSelection = ({route,navigation}) => {
    ...
    const [selectedOption, setSelectedOption] = useState({label: "Male", value: "male"});
        ...
        <View style={styles.Screencontainer}>
            ...
            <View style={styles.Footer}>
                <GofitBtnMain
                    ...
                    onPress={() => navigation.navigate('AgeSelection',{userData:{...userData, gender:selectedOption.value}})}
                />
            </View>
        </View>
    )
