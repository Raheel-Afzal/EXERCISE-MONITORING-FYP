  ...
  const getProgressPhotos = async () => {
    try {
      const response = await fetch(
        `http://${IP}/EM_API/api/ProgressPhotos/getProgressPhotos?USERID=${userData.uid}`,
      );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.userInfo}>
        <View style={styles.imgContainer}>
          <Image
            ...
            source={
              userData.profilePic
                ? {uri: `http://${IP}/EM_API/UserImages/${userData.profilePic}`}
        ...
        <View style={styles.userDetails}>
          ...
          <Text style={{color: COLORS.dark}}>
            {userData.gender}, {userData.age} years old
          </Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          navigation.navigate('GalleryScreen', {userData});
        }}>
        <Text>{'View All >'}</Text>
      </TouchableOpacity>
      <View style={styles.gallery}>
        <TouchableOpacity
          onPress={() => {
            navigation.navigate('AddProgressImage', {uid: userData.uid});
          }}
          style={styles.cameraIconBox}>
          <Image
      ...
      <View style={styles.footer}>
        <View style={styles.iconsWrapper}>
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('LogScreen', {userId: userData.uid})
            }>
            <Text style={styles.editProfileText}>Show your Logs</Text>
          </TouchableOpacity>
        </View>
        <TouchableOpacity
          onPress={() => {
