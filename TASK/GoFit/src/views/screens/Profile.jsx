    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.gallery}>
                <TouchableOpacity onPress={() => { navigation.navigate('AddProgressImage', { uid: userData.uid }) }} style={styles.cameraIconBox}>
                    <Image
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity onPress={() => { handleExitApp() }} style={styles.iconsWrapper}>
                    <Image
                        style={{ height: 30, width: 30 }}
